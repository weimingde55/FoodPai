package com.mobilephone.foodpai.widget;
...
public class MaterialLayout extends RelativeLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout_mycolor, Color.TRANSPARENT);
        mDuration = typedArray.getInteger(R.styleable.MaterialLayout_myduration, DEFAULT_DURATION);
        mFrameRate = typedArray.getInteger(R.styleable.MaterialLayout_myframerate, DEFAULT_FRAME_RATE);
        mColorAlpha = typedArray.getInteger(R.styleable.MaterialLayout_myalpha, DEFAULT_ALPHA);
        mCircleScale = typedArray.getFloat(R.styleable.MaterialLayout_myscale, DEFAULT_SCALE);
    ...
    private void calculateMaxRadius(View view) {
        ...
        // 计算每次alpha递减的值
        mAlphaStep = (mColorAlpha - 50) / redrawCount;
    }
